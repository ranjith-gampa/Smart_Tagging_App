 ...
 */
public class NfcClearTag extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  textView1 = (TextView) findViewById(R.id.textView);
        ...
        tagID=sharedPreferences.getString("TagId",null);
...
//            counters=  getIntent().getExtras().getLong("Length");
        ...
        //Toast.makeText(NfcClearTag.this,counter+" :"+counters,Toast.LENGTH_SHORT).show();
    ...
    protected void onNewIntent(Intent intent) {
        ...
        if (intent.hasExtra(NfcAdapter.EXTRA_TAG)) {
            ...
            if ((access_control & 0x1) == 0x1) {
                ...
                reference_patients=reference_app.child("Tags/"+tagID);
                ...
                LogValue="Tag Id Cleared at: "+s.format(new Date())+" by "+uname;
                s.format(new Date());
    ...
    private void enableForegroundDispatchSystem() {
        ...
        Intent intent = new Intent(this, NfcClearTag.class).addFlags(Intent.FLAG_RECEIVER_REPLACE_PENDING);
    ...
    private void writeNdefMessage(Tag tag, NdefMessage ndefMessage) {
        ...
        try {
            ...
            if (ndef == null) {
                ...
                Toast.makeText(this, "Tag Cleared!", Toast.LENGTH_SHORT).show();
                Log.d("NFCTAG", "Tag Cleared!");
            }
